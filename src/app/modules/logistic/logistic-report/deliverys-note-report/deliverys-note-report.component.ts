...
@Component({
  selector: 'app-deliverys-note-report',
  templateUrl: './deliverys-note-report.component.html',
  styleUrls: ['./deliverys-note-report.component.scss']
})
export class DeliverysNoteReportComponent {
