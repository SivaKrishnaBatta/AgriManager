...
@Component({
  selector: 'app-shipping-method-freight',
  templateUrl: './shipping-method-freight.component.html',
  styleUrls: ['./shipping-method-freight.component.scss']
})
export class ShippingMethodFreightComponent {
